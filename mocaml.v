...
Inductive expr : Set := 
 ...
 | E_cutin (expr5:expr) (expr':expr) (expr'':expr)
 ...
 | E_fork_exprs (expr5:expr) (expr':expr)
...
Fixpoint is_expr_of_expr (e_5:expr) : Prop :=
  ...
  | (E_cutin expr5 expr' expr'') => ((is_expr_of_expr expr5) /\ (is_expr_of_expr expr') /\ (is_expr_of_expr expr''))
  ...
  | (E_fork_exprs expr5 expr') => ((is_expr_of_expr expr5) /\ (is_expr_of_expr expr'))
...
Fixpoint subst_expr (e_5:expr) (x_5:value_name) (e__6:expr) {struct e__6} : expr :=
  ...
  | (E_cutin expr5 expr' expr'') => E_cutin (subst_expr e_5 x_5 expr5) (subst_expr e_5 x_5 expr') (subst_expr e_5 x_5 expr'')
  ...
  | (E_fork_exprs expr5 expr') => E_fork_exprs (subst_expr e_5 x_5 expr5) (subst_expr e_5 x_5 expr')
...
with Get : G -> expr -> typexpr -> Prop :=    (* defn Get *)
 ...
 | Get_fork : forall (G5:G) (e e':expr) (t1 t2:typexpr),
     Get G5 e t1 ->
     Get G5 e' t2 ->
     Get G5 (E_fork_exprs e e') (TE_concurrent  (TE_prod t1 t2) )
 ...
 | Get_cutin : forall (G5:G) (e e' e'':expr) (t t' t'':typexpr),
     Get G5 e''  (TE_arrow  (TE_sum  (TE_sum  (TE_prod t' t'')   (TE_prod t'  (TE_concurrent t'') ) )   (TE_prod  (TE_concurrent t')  t'') )  (TE_concurrent t))  ->
     Get G5 e' t'' ->
     Get G5 e t' ->
     Get G5 (E_cutin e e' e'') (TE_concurrent t)
...
Inductive JO_red : expr -> expr -> Prop :=    (* defn red *)
 ...
 | JO_red_fork1 : forall (e e' e'':expr),
     JO_red e e'' ->
     JO_red (E_fork_exprs e e') (E_fork_exprs e'' e')
 ...
 | JO_red_forkdeath : forall (v v':expr),
     is_value_of_expr v ->
     is_value_of_expr v' ->
     JO_red (E_fork_exprs v v') (E_dead_expr (E_pair v v'))
 ...
 | JO_red_cutin1 : forall (e1 e2 e3 e4 e5:expr),
     JO_red (E_fork_exprs e1 e2) (E_fork_exprs e4 e5) ->
     JO_red (E_cutin e1 e2 e3) (E_cutin e4 e5 e3)
 | JO_red_cutinval : forall (v1 v2 e3:expr),
     is_value_of_expr v1 ->
     is_value_of_expr v2 ->
     JO_red (E_cutin v1 v2 e3) (E_apply e3  (E_taggingleft  (E_taggingleft (E_pair v1 v2)) ) )
 | JO_red_cutinright : forall (v1 e2 e3:expr),
     is_value_of_expr v1 ->
     JO_red (E_cutin v1 e2 e3) (E_apply e3  (E_taggingleft  (E_taggingright (E_pair v1  (E_apply (E_constant CONST_ret) e2) )) ) )
 | JO_red_cutinright : forall (e1 v2 e3:expr),
     is_value_of_expr v2 ->
     JO_red (E_cutin e1 v2 e3) (E_apply e3  (E_taggingright  (E_taggingright (E_pair  (E_apply (E_constant CONST_ret) e1)  v2)) ) )
