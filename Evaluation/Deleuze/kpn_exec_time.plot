...
"kpn_mcon_data_clean_realtime.txt" using log10(1):2 with lp title 'MOCaml', \
...
"kpn_mcon_data_clean_mem.txt" using log10(1):2 with lp title 'MOCaml', \
...
plot "< paste kpn_cont_data_clean_realtime.txt kpn_mcon_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs cont', \
"< paste kpn_promise_data_clean_realtime.txt kpn_mcon_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs promise', \
"< paste kpn_tramp_data_clean_realtime.txt kpn_mcon_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs tramp', \
"< paste kpn_vm_data_clean_realtime.txt kpn_mcon_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs vm', \
"< paste kpn_lwt_data_clean_realtime.txt kpn_mcon_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs lwt', \
"< paste kpn_sys_data_clean_realtime.txt kpn_mcon_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs sys'

#"< paste kpn_dlcont_data_clean_realtime.txt kpn_mcon_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs dlcont',
...
"kpn_mcon_opt_data_clean_realtime.txt" using log10(1):2 with lp title 'MOCaml', \
...
#"kpn_dlcont_opt_data_clean_realtime.txt" using log10(1):2 with lp title 'dlcont', 
...
"kpn_mcon_opt_data_clean_mem.txt" using log10(1):2 with lp title 'MOCaml', \
...
plot "< paste kpn_cont_opt_data_clean_realtime.txt kpn_mcon_opt_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs cont', \
"< paste kpn_promise_opt_data_clean_realtime.txt kpn_mcon_opt_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs promise', \
"< paste kpn_tramp_opt_data_clean_realtime.txt kpn_mcon_opt_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs tramp', \
"< paste kpn_lwt_opt_data_clean_realtime.txt kpn_mcon_opt_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs lwt', \
"< paste kpn_sys_opt_data_clean_realtime.txt kpn_mcon_opt_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs sys'

#"< paste kpn_dlcont_opt_data_clean_realtime.txt kpn_mcon_opt_data_clean_realtime.txt" using log10(1):($4/$2) with lp title 'MOCaml vs dlcont', 
