...
"sieve_mcon_data_clean_realtime.txt" using 1:2 with lp title 'MOCaml', \
...
"sieve_mcon_ftt_data_clean_realtime.txt" using 1:2 with lp title 'MOCaml_{ftt}'
...
"sieve_mcon_data_clean_mem.txt" using 1:2 with lp title 'MOCaml', \
...
"sieve_mcon_ftt_data_clean_mem.txt" using 1:2 with lp title 'MOCaml_{ftt}'
...
plot "< paste sieve_cont_data_clean_realtime.txt sieve_mcon_ftt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs cont', \
"< paste sieve_promise_data_clean_realtime.txt sieve_mcon_ftt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs promise', \
"< paste sieve_tramp_data_clean_realtime.txt sieve_mcon_ftt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs tramp', \
"< paste sieve_vm_data_clean_realtime.txt sieve_mcon_ftt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs vm', \
"< paste sieve_lwt_data_clean_realtime.txt sieve_mcon_ftt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs lwt', \
"< paste sieve_sys_data_clean_realtime.txt sieve_mcon_ftt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs sys'

#"< paste sieve_dlcont_data_clean_realtime.txt sieve_mcon_ftt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs dlcont',
...
"sieve_mcon_opt_data_clean_realtime.txt" using 1:2 with lp title 'MOCaml', \
...
"sieve_mcon_ftt_opt_data_clean_realtime.txt" using 1:2 with lp title 'MOCaml_{ftt}'
...
"sieve_mcon_opt_data_clean_mem.txt" using 1:2 with lp title 'MOCaml', \
...
"sieve_mcon_ftt_opt_data_clean_mem.txt" using 1:2 with lp title 'MOCaml_{ftt}'
...
plot "< paste sieve_cont_opt_data_clean_realtime.txt sieve_mcon_ftt_opt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs cont', \
"< paste sieve_promise_opt_data_clean_realtime.txt sieve_mcon_ftt_opt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs promise', \
"< paste sieve_tramp_opt_data_clean_realtime.txt sieve_mcon_ftt_opt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs tramp', \
"< paste sieve_lwt_opt_data_clean_realtime.txt sieve_mcon_ftt_opt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs lwt', \
"< paste sieve_sys_opt_data_clean_realtime.txt sieve_mcon_ftt_opt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs sys'

#"< paste sieve_dlcont_opt_data_clean_realtime.txt sieve_mcon_ftt_opt_data_clean_realtime.txt" using 1:($4/$2) with lp title 'MOCaml_{ftt} vs dlcont', 
