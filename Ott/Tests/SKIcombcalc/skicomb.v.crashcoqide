(* generated by Ott 0.21.2 from: skicomb.ott *)
...
Extract Inductive reduce => "reduce" ["reduce t_idapp t" "reduce t_selapp t" "reduce t_subapp (t_app  (t_app t t'')   (t_app t' t'') )" "reduce t1 t1' -> reduce (t_app t1 t) (t_app t1' t)"].

Recursive Extraction var eq_var term tsubst_term reduce.