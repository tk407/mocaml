let f2 : int mvar = make_mvar ()
let f3 : int mvar = make_mvar ()
let f5 : int mvar = make_mvar ()
...
let te2 =  foreverbind (boxe (map_mvar f2 t2)) 1021 1022
let t3 i = (print_string "T3 out: "; print_int (3*i); print_string "\n";(put_mvar m3 (3*i)))
let te3 =  foreverbind (boxe (map_mvar f3 t3)) 1031 1032
let t5 i = (print_string "T5 out: "; print_int (5*i); print_string "\n";(put_mvar m5 (5*i)))
let te5 =  foreverbind (boxe (map_mvar f5 t5)) 1051 1052
...
let rec printer = fun i -> (print_int i; print_string "\n"; (	 >>= func 2 tunit (boxe (put_mvar f5 i)) )
...
let tracer_kpn () = printmvar f2 "f2"; printmvar f3 "f3"; printmvar f5 "f5"; printmvar m2 "m2"; printmvar m3 "m3"; printmvar m5 "m5";  printmvar m35 "m35"; printmvar m235 "m235"
