...
Lemma red_not_value : forall (e : expr) (e' : expr), (JO_red e e') -> (~(is_value_of_expr e)).
Proof.
 intro e.
 induction e.
 intros.
 ...
 intros.
 inversion H.
 assert  (~ is_value_of_expr e1).
 apply IHe1 with (e' := e'0).
 trivial.
 contradiction.
 assert  (~ is_value_of_expr e2).
 apply IHe2 with (e' := e'0).
 trivial.
 contradiction.
 assert (is_value_of_expr e1).
 rewrite <- H0.
