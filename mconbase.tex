...
\ottpremise{ \ottnt{e'}  \notin \textit{Values} }%
 ...
 \ottkw{fork} \, \ottsym{(}  Live \, \ottnt{e}  \ottsym{)} \, \ottsym{(}  Live \, \ottnt{e'}  \ottsym{)} \, \overset{  \ottnt{rl}  }{\underset{   1  \, \ottnt{s}  }{\longrightarrow} }\,  \ottkw{fork} \, \ottsym{(}  Live \, \ottnt{e''}  \ottsym{)} \, \ottsym{(}  Live \, \ottnt{e'}  \ottsym{)} }{%
...
\ottpremise{ \ottnt{e}  \notin \textit{Values} }%
 ...
 \ottkw{fork} \, \ottsym{(}  Live \, \ottnt{e}  \ottsym{)} \, \ottsym{(}  Live \, \ottnt{e'}  \ottsym{)} \, \overset{  \ottnt{rl}  }{\underset{   2  \, \ottnt{s}  }{\longrightarrow} }\,  \ottkw{fork} \, \ottsym{(}  Live \, \ottnt{e}  \ottsym{)} \, \ottsym{(}  Live \, \ottnt{e''}  \ottsym{)} }{%
...
\newcommand{\ottdruleJOXXredXXforkdeathOne}[1]{\ottdrule[#1]{%
 ...
 \ottkw{fork} \, \ottsym{(}  Live \, \ottnt{v}  \ottsym{)} \, \ottsym{(}  Live \, \ottnt{e}  \ottsym{)} \, \overset{  \tau  }{\underset{  \ottnt{s}  }{\longrightarrow} }\,  Live \, \ottsym{(}  \textbf{left} \, \ottsym{(}  \ottsym{(}  \{  \ottnt{v}  ,  \ottsym{(}  Live \, \ottnt{e}  \ottsym{)}  \}  \ottsym{)}  \ottsym{)}  \ottsym{)} }{%
...
\newcommand{\ottdruleJOXXredXXforkdeathTwo}[1]{\ottdrule[#1]{%
 ...
 \ottkw{fork} \, \ottsym{(}  Live \, \ottnt{e}  \ottsym{)} \, \ottsym{(}  Live \, \ottnt{v'}  \ottsym{)} \, \overset{  \tau  }{\underset{  \ottnt{s}  }{\longrightarrow} }\,  Live \, \ottsym{(}  \textbf{right} \, \ottsym{(}  \{  \ottsym{(}  Live \, \ottnt{e}  \ottsym{)}  ,  \ottnt{v'}  \}  \ottsym{)}  \ottsym{)} }{%
