...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{./kpn_exec_times_bw}
\caption{Kpn execution time}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{./sieve_exec_times_bw}
\caption{Sieve of Eratosthenes execution time}
\label{fig:sieve_exec_times}
\end{figure}
\subsubsection{Concurrent sort}
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{./sorter_exec_times_bw}
\caption{Concurrent sort execution time}
\label{fig:sorter_exec_times}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{./sorter_mem_bw}
\caption{Concurrent sort memory use}
