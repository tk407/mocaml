...
\item{\textbf{vm}: A lightweight concurrency implementation based on the \verb|thread| library of OCaml.}
...
\end{enumerate}
\subsection{Methods}
Deleuze provides three examples to evaluate, based on the examples used in Kahn's process language paper\cite{kahn1976coroutines}. I have implemented the examples in my system and measured the runtime and memory use for various input sizes. The runtime was measured with \textit{Unix.time}
\subsection{Examples}
