...
Concurrency in a language can be modelled in various ways
...
However with the help of a plugin developed by David Delahaye, Catherine Dubois, Jean-Fr\'ed\'eric \'Etienne and Pierre-Nicolas Tollitte \cite{tollitte2012producing} by marking different modalities of the elements of a relation we can generate code with an input-output convention.
