(* generated by Ott 0.23 from: ./mconpolyml.ott *)
...
let rec is_expr_of_expr (e_5:expr) : bool =
  ...
  | (E_let (value_name,expr,expr')) -> ((is_expr_of_expr expr) && (is_expr_of_expr expr'))
...
let rec subst_expr (e_5:expr) (x_5:value_name) (e__6:expr) : expr =
  ...
  | (E_let (value_name,expr,expr')) -> E_let (value_name,(subst_expr e_5 x_5 expr),(if List.mem x_5 ([value_name]) then expr' else (subst_expr e_5 x_5 expr')))
